...
<body>
    <div class="container mt-5">
        ...
        <form action={{ route('teachers.update', $teacher->id) }} class="col-6" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="form-group mt-3">
                ...
                <textarea class="form-control" id="exampleFormControlTextarea1" name="body" rows="3">{{ $teacher->body }}</textarea>
            </div>
            <div class="form-group mt-3">
